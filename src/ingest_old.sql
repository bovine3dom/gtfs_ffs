...
-- select geoToH3(stop_lat, stop_lon, 11) h3 from transitous_everything_edgelist_fahrtle limit 1;
-- 
-- ALTER TABLE transitous_everything_edgelist_fahrtle ADD COLUMN h3 UInt64 DEFAULT geoToH3(stop_lat, stop_lon, 11);
-- OPTIMIZE TABLE transitous_everything_edgelist_fahrtle;

-- create table transitous_everything_edgelist_fahrtle_oops
-- ENGINE MergeTree
-- ORDER BY (h3, source, stop_uuid, sane_route_id, stop_lat, stop_lon, trip_id, arrival_time, departure_time)
-- --(stop_uuid, source, sane_route_id, trip_id, next_stop, stop_lat, stop_lon, arrival_time, departure_time)
-- settings allow_nullable_key = 1
-- AS
-- select * from transitous_everything_edgelist_fahrtle;
-- 
-- exchange tables transitous_everything_edgelist_fahrtle and transitous_everything_edgelist_fahrtle_oops;
-- 
-- drop table transitous_everything_edgelist_fahrtle_oops;
